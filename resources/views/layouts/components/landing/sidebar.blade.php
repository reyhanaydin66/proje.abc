                    ...
                    <div class="main-sidebar">
                        ...
                        <nav class="main-menu-container nav nav-pills sub-open">
                            ...
                            <div class="d-lg-flex d-none">
                                <div class="btn-list d-lg-flex d-none">
                                    <a href="{{url('signup-basic')}}" class="btn btn-wave btn-success">
                                        Sign Up
                                    </a>
                                    <button type="button" aria-label="button" class="btn btn-wave btn-icon btn-light" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas">
