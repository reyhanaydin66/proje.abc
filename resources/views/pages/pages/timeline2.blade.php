...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Timeline 2</h4>
                        <div class="ms-sm-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Timeline</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Timeline 2</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="main-content app-content">
                        <div class="container-fluid">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-8 col-sm-10">
                                    <ul class="timeline-center list-unstyled">
                                        <li>
                                            <div class="timeline-center-time">
                                            <span class="time d-inline-block">Just Now</span>
                                            </div>
                                            <div class="timeline-center-icon">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                            <div class="timeline-center-body">
                                        ...
                                        <li class="timeline-center-widget">
                                            <div class="timeline-center-time-right">
                                            <span class="time d-inline-block ms-1">Today</span>
                                            </div>
                                            <div class="timeline-center-icon-right">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                            <div class="timeline-center-body-right">
                                                <div class="d-flex align-items-top timeline-main-content mt-0">
                                                    <div class="flex-fill">
                                                        <div class="align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                <p class="mb-0 fs-14 fw-semibold">Dwayne Bero</p>
                                                                <p class="mb-0 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, repellendus rem rerum excepturi aperiam ipsam temporibus cumque,</p>
                                                                <div class="text-center demo-gallery">
                                                                    <div class="mt-2">
                                                                        <div  class="d-flex row row-sm gy-4">
                                                                            <span class="col-6 col-lg-4">
                                                                                <a href="javascript:void(0)">
                                                                                    <img class="img-responsive br-5 w-100" src="{{asset('build/assets/images/media/media-27.jpg')}}" alt="Thumb-1">
                                                                                </a>
                                                                            </span>
                                                                            <span class="col-6 col-lg-4">
                                                                                <a href="javascript:void(0)">
                                                                                    <img class="img-responsive br-5 w-100" src="{{asset('build/assets/images/media/media-28.jpg')}}" alt="Thumb-1">
                                                                                </a>
                                                                            </span>
                                                                            <span class="col-6 col-lg-4">
                                                                                <a href="javascript:void(0)">
                                                                                    <img class="img-responsive br-5 w-100" src="{{asset('build/assets/images/media/media-30.jpg')}}" alt="Thumb-1">
                                                                                </a>
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <li>
                                            <div class="timeline-center-time">
                                            <span class="time d-inline-block">Yesterday</span>
                                            </div>
                                            <div class="timeline-center-icon">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                ...
                                                                <p class="mb-0 text-muted">Temporary data will be <span class="badge bg-danger-transparent fw-semibold mx-1">deleted</span> once dedicated time complated Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
                                                            </div>
                                                            <div class="d-flex align-items-end">
                                                                <button class="btn btn-light btn-sm   mt-2">
                                                                50k &#128150;
                                                                </button>
                                                                <span class="ms-auto badge bg-light text-muted timeline-badge mt-2  rounded-1">
                                                                    08:10 AM
                                                                </span>
                                                            </div>
                                                        </div>
                                        ...
                                        <li class="timeline-center-widget">
                                            <div class="timeline-center-time-right">
                                            <span class="time d-inline-block ms-1">02-5-2023</span>
                                            </div>
                                            <div class="timeline-center-icon-right">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                ...
                                                                <p class="mb-0 text-muted">Social network accounts are at risk check your <span class="badge bg-success-transparent fw-semibold mx-1">login</span> details Lorem ipsum dolor sit amet consectetur adipisicing elit
                                                                    <a  href="javascript:void(0);" class="text-primary ms-2 text-decoration-underline">Read more</a></p>
                                                            </div>
                                                            <div class="ms-auto">
                                                                <span class="float-end badge bg-light text-muted timeline-badge mt-2  rounded-1">
                                                                    10:10 AM
                                        ...
                                        <li>
                                            <div class="timeline-center-time">
                                            <span class="time d-inline-block">02-5-2023</span>
                                            </div>
                                            <div class="timeline-center-icon">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                            <div class="timeline-center-body">
                                                <div class="d-flex align-items-top timeline-main-content  mt-0">
                                                    <div class="avatar avatar-md online me-3 avatar-rounded mt-sm-0 mt-4 flex-none">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="align-items-center">
                                                            ...
                                                            <div class="d-flex align-items-end gap-2">
                                                                <button class="btn btn-light btn-sm   mt-2 me-2">
                                                                73k &#128077;
                                                                </button>
                                                                <button class="btn btn-light btn-sm   mt-2">
                                                                55 &#128525;
