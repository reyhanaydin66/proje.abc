...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Product Details</h4>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="card custom-card bg-transparent shadow-none border rounded">
                                                            <div class="card-header flex-between justify-content-between">
                                                                <div class="card-title">Frequently bought together</div>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="d-flex justify-content-evenly mt-4">
                                                                    <div class="">
                                                                        <div class="text-center">
                                                                            ...
                                                                            <h5 class="mb-1 fs-12 fw-semibold   mt-1">Omega Sports shoes series 3</h5>
                                                                            <p class="mb-0 text-muted fs-12 px-3">Aluminium Case with Multiple Featured Sports Band - Regular</p>
                                                                    ...
                                                                    <div class=" d-flex ">
                                                                        <span class="text-muted fs-25 fw-semibold"><i class="bx bx-plus"></i></span>
                                                                    </div>
                                                                    <div class="">
                                                                        <div class="text-center">
                                                                            <div class="avatar avatar-xxl bg-light p-1">
                                                                            ...
                                                                            <p class="mb-0 text-muted fs-12 px-3">Aluminium Case with Multiple Featured Sports Band - Regular</p>
                                                                            <div class="flex-fill mb-1">
                                                                                <span class="badge bg-success rounded-1">4.0<i class="ri-star-s-fill ms-1"></i></span>
                                                ...
                                                <div class="col-xxl-8 col-xl-12 ">
                                                    <div class="row g-0 product-scroll rounded-3 p-3 px-0">
                                                        <div class="col-xl-8 mt-xxl-0 mt-3">
                                                            <div>
                                                                <p class="fs-18 fw-semibold mb-0">Omega Men's Sports Running, Walking, Gym Shoes with Ultra bounce. Comfortable and Durable.</p>
                                                                <p class="fs-18 mb-4">
                                                                ...
                                                                <div class="row mb-4">
                                                                    <div class="col-xxl-3 col-xl-12">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <h3 class="mb-1 fw-semibold"><span>$229.00</span></h3>
                                                                            <span class="text-muted text-decoration-line-through d-inline-block ms-1  fs-16 op-6">$2,799</span>
                                                                        </div>
                                                                ...
                                                                <div class="mb-4">
                                                                    <a href="{{url('checkout')}}" class="btn btn-secondary me-2 mb-2">Buy Now</a>
                                                                    <a href="{{url('cart')}}" class="btn btn-success me-2 mb-2">Add To Cart</a>
                                                                </div>
                                                                <div class="mb-4">
                                                                    <p class="fs-15 fw-semibold mb-1"><i class="ti ti-discount-2 fs-17 me-1 text-success"></i>Offers:</p>
                                                                    ...
                                                                    <a class="text-success fs-12 ps-2" data-bs-toggle="collapse" href="#more-offers" aria-expanded="false"><u>View More</u></a>
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <div class="row pe-4 ps-3">
                                                                        <div class="border p-0 px-0 rounded-3 mb-0">
                                                                            <p class="fs-15 fw-semibold mb-3 p-3">Reviews &amp; Ratings :</p>
                                                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 p-3 pt-0">
                                                                            ...
                                                                            <div class="p-3">
                                                                                <div class="d-sm-flex d-block align-items-top">
                                                                                    <div class="d-flex flex-fill">
                                                                                        ...
                                                                                        <div class="">
                                                                                            <h6 class="">Alex Carey
                                                                                                <span class="badge bg-warning-transparent mb-0 rounded-1"><i class="ri-star-s-fill">4.5</i></span></h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="product-images ps-sm-4 ps-0">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-xl-6 d-flex align-items-end justify-content-sm-end mt-sm-0 mt-2">
                                                                                            <button aria-label="button" type="button" class="btn btn-sm btn-icon btn-primary-light me-2">
                                                                            ...
                                                                            <div class="p-3">
                                                                                <div class="d-sm-flex d-block align-items-top">
                                                                                    <div class="d-flex flex-fill">
                                                                                        ...
                                                                                        <div class="">
                                                                                            <h6 class="">Alex Carey
                                                                                                <span class="badge bg-warning-transparent mb-0 rounded-1"><i class="ri-star-s-fill">4</i></span></h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="ps-sm-4 ps-0 mb-3">
                                                        ...
                                                        <div class="border p-3 rounded-3 mb-3">
                                                            <p class="fs-16 fw-semibold mb-2">Product Details :</p>
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <div class="row">
                                                                        <div class="col-xl-5">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-5">
                                                                        <span class="fs-14 fw-semibold">Model Name</span>
                                                                        </div>
                                                                        <div class="col-xl-7">
                                                                            <p class="text-muted fs-14"> Orange Travel bag series 4</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-xl-5">
                                                                        <span class="fs-14 fw-semibold">Color</span>
                                                                        </div>
                                                                        <div class="col-xl-7">
                                                                            <p class="text-muted fs-14">Raging Brass</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-xl-5">
                                                                        <span class="fs-14 fw-semibold">Style</span>
                                                                        </div>
                                                                        <div class="col-xl-7">
                                                                            <p class="text-muted fs-14">GPS</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-xl-5">
                                                                        <span class="fs-14 fw-semibold">Special Features</span>
                                                                        </div>
                                                                        <div class="col-xl-7">
                                                                            <p class="text-muted fs-14">Heart rate sensor,GPS,Wifi calling,SAmoled display e.t.c</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        <div class="card-header">
                                            <div class="card-title">Similar Products</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xl-2 col my-2">
                                                    <div class="text-center">
                                                        <div class="similar-products-image me-2">
                                                            <img src="{{asset('build/assets/images/ecommerce/png/16.png')}}" alt="">
                                                        </div>
                                                        <h5 class="mb-1 fs-14 fw-semibold   mt-1">Omega Sports shoes series 3</h5>
                                                ...
                                                <div class="col-xl-2 col my-2">
                                                    <div class="text-center">
                                                        ...
                                                        <div class="flex-fill">
                                                            <span class="badge bg-success rounded-1">4.3<i class="ri-star-s-fill ms-1"></i></span>
                                                ...
                                                <div class="col-xl-2 col my-2">
                                                    <div class="text-center">
                                                        ...
                                                        <div class="flex-fill">
                                                            <span class="badge bg-success rounded-1">3.5<i class="ri-star-s-fill ms-1"></i></span>
                                                            <span class="text-muted ms-1">(19,256)</span>
                                                        </div>
                                                    </div>
