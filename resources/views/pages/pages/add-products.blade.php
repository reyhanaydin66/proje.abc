...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Add Products</h4>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body add-products p-0">
                                                            ...
                                                            <div class="card-body p-0">
                                                                <div class="row gy-3">
                                                                    ...
                                                                    <div class="col-xl-12 product-documents-container">
                                                                        ...
                                                                        <input type="file" class="product-documents" multiple data-allow-reorder="true" data-max-file-size="3MB" data-max-files="6">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="card-body p-0">
                                                                <div class="row gy-4">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <input class="form-control" id="choices-text-unique-values" type="text" value="Plain, Relaxed" placeholder="This is a placeholder">
                                                                    </div>
                                                                    <div class="col-xl-12">
                                            ...
                                            <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
                                                <button type="button" class="btn btn-primary-light m-1">Add Product<i class="bi bi-plus-lg ms-2"></i></button>
                                                <button type="button" class="btn btn-success-light m-1">Save Product<i class="bi bi-download ms-2"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
