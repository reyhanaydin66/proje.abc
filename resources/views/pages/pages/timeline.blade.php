...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Timeline 1</h4>
                        <div class="ms-sm-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Timeline</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Timeline 1</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-xxl-9 col-xl-10 col-sm-12">
                                    <ul class="timeline list-unstyled">
                                        <li>
                                            ...
                                            <span class="time d-inline-block">Today</span>
                                            </div>
                                                                ...
                                                                <div class="text-center demo-gallery">
                                                                    <div class="mt-2">
                                                                        <div  class="d-flex row row-sm">
                                                                            <span class="col-sm-6 col-lg-4 mb-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                ...
                                                                <p class="mb-0 text-muted">Temporary data will be <span class="badge bg-danger-transparent fw-semibold mx-1">deleted</span> once dedicated time complated Lorem ipsum dolor sit amet consectetur adipisicing elit time complated Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
                                                            </div>
                                        ...
                                        <li>
                                            <div class="timeline-time text-end">
                                            <span class="time d-inline-block">05 May</span>
                                            </div>
                                            <div class="timeline-icon">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="align-items-center">
                                                            <div class="mt-sm-0 mt-2">
                                                                ...
                                                                <p class="mb-0 text-muted">Social network accounts are at risk check your <span class="badge bg-success-transparent fw-semibold mx-1">login</span> details Lorem ipsum dolor sit amet consectetur adipisicing
                                        ...
                                        <li>
                                            <div class="timeline-time text-end">
                                            <span class="time d-inline-block">04 May</span>
                                            </div>
                                            <div class="timeline-icon">
                                            <a href="javascript:void(0);"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="timeline-time text-end">
                                            <span class="time d-inline-block">15 Sep</span>
                                            </div>
                                            <div class="timeline-icon">
                                            <a href="javascript:void(0);"></a>
                                            </div>
