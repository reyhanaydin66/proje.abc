...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Helpers</h4>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="bg-light clearfix">
                                                <button type="button" class="btn btn-primary float-start mb-2 mb-sm-0">Example Button
                                                    floated left</button>
                                                <button type="button" class="btn btn-primary float-end">Example Button
                                                    floated
                                                    right</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-evenly flex-wrap">
                                                ...
                                                <a href="javascript:void(0);" class="link-light fw-semibold fs-15 p-1 bg-dark rounded-1">Light</a>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body bd-example-ratios bd-example-ratios-breakpoint">
                                                    ...
                                                    <div class="ratio ratio-4x3 ms-sm-5">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="vstack gap-3">
                                                <div class="bg-light border p-1 rounded">First item</div>
                                                <div class="bg-light border p-1 rounded">Second item</div>
                                                <div class="bg-light border p-1 rounded">Third item</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="hstack gap-3 mb-3">
                                                <div class="bg-light border p-1 rounded">First item</div>
                                                <div class="bg-light border ms-auto p-1 rounded">Second item</div>
                                                <div class="bg-light border p-1 rounded">Third item</div>
                                            </div>
