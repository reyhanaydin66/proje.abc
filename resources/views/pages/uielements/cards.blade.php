...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Cards</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-footer">
                                            <a href="javascript:void(0);" class="card-link text-danger">Buy Now</a>
                                            <a href="javascript:void(0);" class="card-link text-success d-inline-flex"><u>Review</u></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card">
                                        <img src="{{asset('build/assets/images/media/media-16.jpg')}}" class="card-img-top" alt="...">
                                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="card custom-card border border-success mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="card custom-card">
                                        <div class="card-header justify-content-between">
                                            ...
                                            <a aria-label="anchor" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                ...
                                <div class="col-md-4">
                                    <div class="card custom-card">
                                        <div class="card-header justify-content-between">
                                            ...
                                            <a aria-label="anchor" href="javascript:void(0);" data-bs-toggle="card-remove">
                                    ...
                                    <div class="card custom-card bg-dark overlay-card">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0">
                                            ...
                                            <div class="card-body overflow-y-scroll">
                                                ...
                                                <div class="card-text  text-fixed-white">Last updated 3 mins ago</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card  custom-card bg-dark overlay-card">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-body overflow-y-scroll">
                                                ...
                                                <div class="card-text mb-2 text-fixed-white text-truncate">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                                            </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card bg-dark overlay-card">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0">
                                            ...
                                            <div class="card-body overflow-y-scroll">
                                                <div class="card-text text-fixed-white">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                                            </div>
                                            <div class="card-footer text-fixed-white">Last updated 3 mins ago</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card custom-card card-bg-primary">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center w-100">
                                                ...
                                                <div class="ms-auto">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="text-fixed-white"><i class="bi bi-three-dots-vertical"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card custom-card card-bg-light">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center w-100">
                                                ...
                                                <div class="ms-auto">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="text-default"><i class="bi bi-three-dots-vertical"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card custom-card card-bg-dark">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center w-100">
                                                ...
                                                <div class="">
                                                    <div class="fs-15 fw-semibold">Pope Adam</div>
                                                    <p class="mb-0 text-white op-7 fs-12">Completed on 24,may</p>
                                                </div>
                                                <div class="ms-auto">
                                    ...
                                    <div class="card border border-info custom-card">
                                        <div class="card-body">
                                            <p class="fs-14 fw-semibold mb-2 lh-1">New Project Discussion
                                                <a aria-label="anchor" href="javascript:void(0);"><i class="bi bi-plus-square float-end text-info fs-18"></i></a>
                                            </p>
                                            <div class="d-flex flex-wrap gap-2 mb-4">
                                                <span class="badge bg-info-transparent">React</span>
                                    ...
                                    <div class="card border border-danger custom-card">
                                        <div class="card-body">
                                            <p class="fs-14 fw-semibold mb-2 lh-1">Recent Projects Testing
                                                <a aria-label="anchor" href="javascript:void(0);"><i class="bi bi-plus-square float-end text-danger fs-18"></i></a>
                                            </p>
                                            <div class="d-flex flex-wrap gap-2 mb-4">
                                    ...
                                    <div class="card border border-light custom-card">
                                        <div class="card-body">
                                            <p class="fs-14 fw-semibold mb-2 lh-1">New Employees
                                                <a aria-label="anchor" href="javascript:void(0);"><i class="bi bi-plus-square float-end text-default fs-18"></i></a>
                                            </p>
                                            <div class="d-flex flex-wrap gap-2 mb-4">
                                                <span class="badge bg-warning-transparent">Html</span>
                                    ...
                                    <div class="card border border-dark custom-card">
                                        <div class="card-body">
                                            <p class="fs-14 fw-semibold mb-2 lh-1">Terminated Employees
                                                <a aria-label="anchor" href="javascript:void(0);"><i class="bi bi-plus-square float-end text-dark fs-18"></i></a>
                                            </p>
                                            <div class="d-flex flex-wrap gap-2 mb-4">
                                        ...
                                        <div class="col-xxl-7 col-xl-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-md-4">
                                                        <img src="{{asset('build/assets/images/media/media-39.jpg')}}" class="img-fluid rounded-end h-100" alt="...">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
