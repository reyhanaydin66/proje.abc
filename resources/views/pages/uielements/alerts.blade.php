...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Alerts</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="alert alert-primary shadow-sm alert-dismissible">A simple primary alert with small shadow—check it out!</div>
                                            ...
                                            <div class="card bg-white border-0">
                                                <div class="alert custom-alert1 alert-primary">
                                                    ...
                                                    <div class="text-center px-5 pb-0">
                                                        ...
                                                        <div class="">
                                                            <button type="button" class="btn btn-sm btn-outline-danger m-1">Decline</button>
                                                            <button type="button" class="btn btn-sm btn-primary m-1">Accept</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card bg-white border-0">
                                                <div class="alert custom-alert1 alert-secondary">
                                                    ...
                                                    <div class="text-center px-5 pb-0">
                                                        ...
                                                        <div class="">
                                                            <button type="button" class="btn btn-sm btn-secondary m-1">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card bg-white border-0">
                                                <div class="alert custom-alert1 alert-warning">
                                                    ...
                                                    <div class="text-center px-5 pb-0">
                                                        ...
                                                        <div class="">
                                                            <button type="button" class="btn btn-sm btn-outline-secondary m-1">Back</button>
                                                            <button type="button" class="btn btn-sm btn-warning m-1">Continue</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
