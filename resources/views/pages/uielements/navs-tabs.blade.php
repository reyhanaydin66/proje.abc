...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Navs &amp; Tabs</h4>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-9">
                                                    <div class="tab-content mt-3 mt-xl-0">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="accepted1" role="tabpanel">
                                                ...
                                                <div class="tab-pane" id="declined1" role="tabpanel">
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-tabs mb-3 tab-style-6" id="myTab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active d-inline-flex" id="products-tab" data-bs-toggle="tab"
                                                        data-bs-target="#products-tab-pane" type="button" role="tab"
                                                        aria-controls="products-tab-pane" aria-selected="true"><i
                                                            class="ri-gift-line me-1 align-middle"></i>Products</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link d-inline-flex" id="sales-tab" data-bs-toggle="tab"
                                                        data-bs-target="#sales-tab-pane" type="button" role="tab"
                                                        aria-controls="sales-tab-pane" aria-selected="false"><i
                                                            class="ri-bill-line me-1 align-middle"></i>Sales</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link d-inline-flex" id="profit-tab" data-bs-toggle="tab"
                                                        data-bs-target="#profit-tab-pane" type="button" role="tab"
                                                        aria-controls="profit-tab-pane" aria-selected="false"><i
                                                            class="ri-money-dollar-box-line me-1 align-middle"></i>Profit</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link d-inline-flex" id="expenses-tab" data-bs-toggle="tab"
                                                        data-bs-target="#expenses-tab-pane" type="button" role="tab"
                                                        aria-controls="expenses-tab-pane" aria-selected="false"><i
                                                            class="ri-exchange-box-line me-1 align-middle"></i>Expenses</button>
                                                </li>
                                            </ul>
                                                    ...
                                                    <ul class="nav nav-tabs flex-column vertical-tabs-2" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                                                ...
                                                                aria-selected="true">
                                                                <p class="mb-0"><i class="ri-home-4-line"></i></p>
                                                                <p class="mb-0">Home</p>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-bs-toggle="tab" role="tab"
                                                                ...
                                                                aria-selected="true">
                                                                <p class="mb-0"><i class="ri-phone-line"></i></p>
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link mb-0" data-bs-toggle="tab" role="tab"
                                                                ...
                                                                aria-selected="true">
                                                                <p class="mb-0"><i class="ri-customer-service-line"></i></p>
