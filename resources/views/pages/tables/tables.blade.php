...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Tables</h4>
                                                ...
                                                <table class="table text-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>29,April 2023</td>
                                                            <td>+1523-12459</td>
                                                            <td><span class="badge bg-secondary-transparent">Failed</span></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="hstack gap-2 fs-15">
                                                                    <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-info-light rounded-pill"><i class="ri-edit-line"></i></a>
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap table-primary overflow-hidden rounded-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap table-secondary overflow-hidden rounded-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                                            <th scope="col">First</th>
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap table-warning overflow-hidden rounded-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                                            <th scope="col">First</th>
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap table-danger overflow-hidden rounded-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                                            <th scope="col">First</th>
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap table-dark overflow-hidden rounded-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                                            <th scope="col">First</th>
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap table-success table-striped overflow-hidden rounded-3">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">#</th>
                                                            <th scope="col">First</th>
                                                            ...
                                                            <td>
                                                                <div class="hstack gap-2 fs-15">
                                                                    <a href="javascript:void(0);"
                                                                        class="btn btn-icon btn-sm btn-success-light rounded-pill"><i
                                ...
                                <div class="col-xl-4">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap">
                                                    <caption class="px-3">Top 3 Countries</caption>
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">S.No</th>
                                        ...
                                        <div class="card-body p-0">
                                            <div class="table-responsive">
                                                <table class="table text-nowrap caption-top">
                                                    <caption class="px-2">Top IT Companies</caption>
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">S.No</th>
                                                            <th scope="col">Name</th>
                                                ...
                                                <table class="table text-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="table-dark">
                                                            ...
                                                            <td>Polly Pipe</td>
                                                            <td><span class="badge bg-dark text-light">Processed</span></td>
                                                            <td>35</td>
                                                            <td>$1,832</td>
                                                        </tr>
                                                    </tbody>
