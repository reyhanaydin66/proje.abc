                                                    ...
                                                    <div class="row m-1">
                                                        <div class="col-xl-4 text-center p-2 team-performance1">
                                                            <a href="javascript:void(0);" class="mb-2">
                                                                <img src="{{asset('build/assets/images/faces/10.jpg')}}" alt="img" width="40" height="40" class="rounded-circle">
                                                            </a>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="avatar-list-stacked mb-0">
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/6.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="user-img">
                                                                            </span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="avatar-list-stacked mb-0">
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/3.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/5.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/10.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/15.jpg')}}" alt="user-img">
                                                                            </span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="avatar-list-stacked mb-0">
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/11.jpg')}}" alt="user-img">
                                                                            </span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="avatar-list-stacked mb-0">
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/13.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/16.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/8.jpg')}}" alt="user-img">
                                                                            </span>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="avatar-list-stacked mb-0">
                                                                            ...
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/12.jpg')}}" alt="user-img">
                                                                            </span>
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/13.jpg')}}" alt="user-img">
                                                                            </span>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="avatar-list-stacked mb-0">
                                                                            <span class="avatar avatar-xs">
                                                                                <img src="{{asset('build/assets/images/faces/4.jpg')}}" alt="user-img">
                                                                            </span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                            ...
                                            <ul class="list-group online-agents">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm avatar-rounded me-2">
                                                                <img src="{{asset('build/assets/images/faces/7.jpg')}}" alt="user-img">
                                                            </div>
                                                            <div class="lh-1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="w-50 border-bottom-0">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="avatar avatar-sm me-2">
                                                                        <img src="{{asset('build/assets/images/faces/1.jpg')}}" alt="user-img">
                                                                    </div>
                                                                    <div class="lh-1">
                                            ...
                                            <div class="row d-lg-flex d-none mb-2 g-0">
                                                ...
                                                <div class="col">
                                                    <a href="{{url('chat')}}" class="avatar-sm avatar-status offline rounded-circle">
                                                        <img src="{{asset('build/assets/images/faces/13.jpg')}}" alt="img" class="avatar avatar-md rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a href="{{url('chat')}}" class="avatar-sm avatar-status rounded-circle">
                                                ...
                                                <div class="col">
                                                    <a href="{{url('chat')}}" class="avatar-sm avatar-status offline rounded-circle">
                                                        <img src="{{asset('build/assets/images/faces/1.jpg')}}" alt="img" class="avatar avatar-md rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a aria-label="anchor" href="{{url('contacts')}}" class="avatar avatar-md rounded-circle btn btn-light text-primary">
